        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
              ...
              <hr
                className="absolute top-0 left-0 h-1 bg-linear-to-br from-blue-500 to-blue-600 border-none transition-all duration-2000"
                style={{
                  width: `${
              ...
              <button
                ...
                className="bg-linear-to-br from-blue-100 to-blue-200 ring-blue-300 text-blue-600 ring hover:ring-blue-400 transition-all rounded-md px-6 py-2 mt-6 text-sm"
              >
                Save Changes
              </button>
            </div>
